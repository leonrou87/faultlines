...
import { Playfair_Display, Source_Serif_4, Libre_Franklin } from "next/font/google";
import Script from "next/script";
import "./globals.css";

// Masthead + headlines: a high-contrast display serif (newspaper nameplate feel).
const display = Playfair_Display({ subsets: ["latin"], weight: ["700", "800", "900"], variable: "--font-display", display: "swap" });
// Body / article text: a readable text serif.
